...
query myQuery(
 ...
 $daily: String = "weathercode,temperature_2m_max,temperature_2m_min,apparent_temperature_max,apparent_temperature_min,sunrise,sunset,uv_index_clear_sky_max,uv_index_max"  
  $hourly: String = "temperature_2m,relativehumidity_2m,apparent_temperature,precipitation,precipitation_probability,windgusts_10m,uv_index,uv_index_clear_sky,snowfall,snow_depth,showers,rain"
   $latitude: String,
    $longitude: String,
     $timezone: String){
